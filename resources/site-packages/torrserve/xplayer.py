...
from vdlib.util.string import humanizeSize
...
class xPlayer(xbmc.Player):
    ...
    def onPlayBackPaused(self):
        ...
        status = ''
        self.paused = True
        while xbmcPlayer.isPlaying() and self.paused:
            if self.ov_visible == True:
                try:
                    ...
                    if percent >= 0:
                        percendSpeed = dl_speed * xbmcPlayer.getTotalTime() / size
                        ...
                        if percent: #< 100:
                                heading += "{}: {}/сек [{:.2f}x]\n".format(
                                    translate("Download Speed"),
                                    humanizeSize(dl_speed), percendSpeed)
