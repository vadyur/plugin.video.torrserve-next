...
if __settings__.getSetting("antizapret") == "true":
	try:
		...
		proxy_support = urllib_request.ProxyHandler({"http" : prx})
		opener = urllib_request.build_opener(proxy_support, hr)
		urllib_request.install_opener(opener)
		print 'antizapret ok'
	except:
		print 'except set proxy'
		opener = urllib_request.build_opener(hr) 
		urllib_request.install_opener(opener)
else:
		opener = urllib_request.build_opener(hr) 
		urllib_request.install_opener(opener)
